...
func main() {
	...
	controllers := &[]internal.Controller{
		...
		&internal.BatteryReminderController{
			BaseController:      internal.BaseController{Name: "freezerdoorbattery"},
		...
		&internal.BatteryReminderController{
			BaseController:      internal.BaseController{Name: "fridgedoorbattery"},
		...
		&internal.BatteryReminderController{
			BaseController:      internal.BaseController{Name: "fridgethermometerbattery"},
			StateBatteryPoorKey: "fridgeThermometerBatteryLow",
			ReminderPeriod:      24 * time.Hour,
			MaxReminders:        20,
			ReminderTopic:       "telegram/regelverkgeneral/send",
			ReminderPayload:     `Battery fridge thermometer is low`,
		},
		&internal.LivingroomFloorlampController{},
		&internal.LivingroomWindowlampController{},
