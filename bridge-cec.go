...
func bridgeKeyPressesNew(ctx context.Context, bridge *cecmqtt.CecMQTTBridge, keyboard uinput.Keyboard) {
...
func initCECBridgeNew(mqttClient mqtt.Client) {
...
outer:
	for {
		...
		go bridgeKeyPressesNew(ctx, bridge, keyboard)
